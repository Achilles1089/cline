...
export class VscodeCommentReviewController extends CommentReviewController implements vscode.Disposable {
	...
	constructor() {
		...
		this.commentController = vscode.comments.createCommentController("dappit-ai-review", "Cline AI Review")
		...
		this.disposables.push(
			vscode.commands.registerCommand("dappit.reviewComment.reply", async (reply: vscode.CommentReply) => {
		...
		this.disposables.push(
			vscode.commands.registerCommand("dappit.reviewComment.addToChat", async (thread: vscode.CommentThread) => {
