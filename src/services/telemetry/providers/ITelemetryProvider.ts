...
export interface ITelemetryProvider {
	 ...
	 * @param name Metric name (e.g., "dappit.tokens.input")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "dappit.api.duration_seconds")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "dappit.workspace.active_roots")
