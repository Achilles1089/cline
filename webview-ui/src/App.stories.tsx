...
const meta: Meta<typeof MockApp> = {
	...
	parameters: {
		...
		docs: {
			description: {
				component: `
The ChatView component is the main interface for interacting with Dappit AI. It provides a comprehensive chat experience with AI assistance, task management, and various tools.
...
export const Onboarding: Story = {
	...
	play: async ({ canvasElement }) => {
		...
		const title = canvas.getByText("How will you use Dappit AI?")
		...
		await expect(canvas.getByText("How will you use Dappit AI?")).toBeInTheDocument()
...
export const ActiveConversation: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "An active conversation showing a typical interaction with Dappit AI, including task creation, tool usage, and AI responses.",
			},
		},
	},
}
...
export const ErrorState: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Shows how Dappit AI handles and displays error messages, helping users understand and resolve issues.",
			},
		},
	},
}
...
export const AutoApprovalEnabled: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Shows the interface with auto-approval enabled, allowing Dappit AI to execute certain actions automatically without user confirmation.",
			},
		},
	},
}
...
export const PlanMode: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Shows Dappit AI in Plan mode, where it focuses on creating detailed plans and discussing approaches before implementation.",
			},
		},
	},
}
...
export const BrowserAutomation: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Shows Dappit AI performing browser automation tasks, including launching browsers, clicking elements, and testing web applications.",
			},
		},
	},
}
...
export const Followup = quickStory(
	...
	"Shows followup question state where Dappit AI asks for next steps.",
)
...
export const PlanModeResponse = quickStory(
	...
	"plan_mode_respond",
	"Here's my comprehensive plan for refactoring your React application with TypeScript migration and performance optimization phases.\n\n\n\n\nPhase 1: TypeScript Migration\n1. Set up TypeScript in the project\n2. Rename .js files to .tsx/.ts\n3. Add type definitions for components and props\n4. Fix type errors and ensure type safety\n\nPhase 2: Performance Optimization\n1. Analyze current performance bottlenecks\n2. Implement code-splitting and lazy loading\n3. Optimize rendering with React.memo and useCallback\n4. Minimize bundle size with tree-shaking and minification\n5. Test performance improvements using profiling tools",
	"Shows plan mode response where Dappit AI presents a detailed plan for user approval.",
)
...
export const ReportBug = quickStory(
	...
	"report_bug",
	JSON.stringify({
		steps_to_reproduce: "1. Open Dappit AI\n2. Start a new task\n3. Observe the error",
		what_happened: "Dappit AI crashes unexpectedly",
	}),
