...
const meta: Meta<typeof ErrorRow> = {
	...
	parameters: {
		docs: {
			description: {
				component:
					"Displays different types of error messages in the chat interface, including API errors, credit limit errors, diff errors, and clineignore errors. Handles special error parsing for Dappit AI provider errors and provides appropriate user actions.",
			},
		},
	},
...
export const InteractiveSignIn: Story = {
	args: {
		...
		errorType: "error",
		apiRequestFailedMessage: JSON.stringify({
			message: "Please sign in to access Dappit AI services.",
			code: "ERR_BAD_REQUEST",
